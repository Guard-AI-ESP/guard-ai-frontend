		...
		<div class="flex rounded-xl bg-slate-100 p-1 mb-6">
			<button
				...
				class="flex-1 py-2 text-sm font-medium rounded-lg transition-all
					{mode === 'login' ? 'bg-primary text-white shadow-md shadow-primary/25' : 'text-slate-500 hover:text-slate-700'}"
			>
				Se connecter
			</button>
			<button
				...
				class="flex-1 py-2 text-sm font-medium rounded-lg transition-all
					{mode === 'register' ? 'bg-primary text-white shadow-md shadow-primary/25' : 'text-slate-500 hover:text-slate-700'}"
			>
				Créer un compte
			</button>
		</div>
